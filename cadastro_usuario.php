    ...
    <script>
        function validarCPF(cpf) {	
            ...
            if (cpf.length != 11 || 
                ...
                cpf == "88888888888" || 
                cpf == "99999999999")
                    alert('CPF inválido - Digitar 11 digitos');	    
                    return false;	
                                        ...
                                        <div class='col mr-2'>
                                            <form action="insere_cadastro.php" method="get">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Digite RG" name="rg" id="rg" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">CPF*</label>
                                                    <input type="text" class="form-control" placeholder="Digite cpf" name="cpf" id="cpf" oninput="mascara(this)" required onBlur="validarCPF(this.value)">
                                                </div>
                                                <div class="form-group">
