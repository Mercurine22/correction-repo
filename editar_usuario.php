<?php
    ...
    $sql_id="SELECT * FROM `tb_usuarios` WHERE id = $id";
            ...
            <div id='content'>
                ...
                <div class='container-fluid'>
                    ...
                    <div class='d-sm-flex align-items-center justify-content-between mb-4'>
                        <h1 class='h3 mb-0 text-gray-800'>Edição de Usuário</h1>
                                        ...
                                        <div class='col mr-2'>
                                            ...
                                            <form action="update_cadastro.php" method="get">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Digite RG" name="rg" id="rg" required value='<?php echo $rg_retorno; ?>'> 
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">CPF</label>
                                                    <input type="text" class="form-control" placeholder="Digite cpf" name="cpf" id="cpf" required value='<?php echo $cpf_retorno; ?>'>
                                                </div>
                                                <div class="form-group">
